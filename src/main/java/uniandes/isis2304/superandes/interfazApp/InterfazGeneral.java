...
/**
 * Clase general de la interfaz
 * @author Sebastián Ospino
 * @author Ana Sofía Castellanos
 */
@SuppressWarnings("serial")
public abstract class InterfazGeneral extends JFrame implements ActionListener {
	 ...
	 */
	protected static Logger log = Logger.getLogger(InterfazAdminDatos.class.getName());
	
	/**
	 * Ruta al archivo de configuración de los nombres de tablas de la base de datos
	 */
	protected static final String CONFIG_TABLAS = "./src/main/resources/config/TablasBD.json"; 
     ...
     */
	protected JsonObject tableConfig;
    
    /**
     * Asociación a la clase principal del negocio.
     */
	protected Superandes superandes;
     ...
     */
	protected JsonObject guiConfig;
     ...
     */
    protected JsonObject openConfig (String tipo, String archConfig)
    {
...
//			e.printStackTrace ();
     ...
     */
    protected void configurarFrame(  )
    {
    	int alto = 0;
    	int ancho = 0;
    	String titulo = "";	
     ...
     */
    protected void crearMenu(  JsonArray jsonMenu )
    {    	
	...
	public void limpiarBD ()
	{
		try 
		{
			...
			resultado += eliminados [0] + " tipos de usuarios eliminados\n";
			resultado += "\nLimpieza terminada";
...
//			e.printStackTrace();
	...
	/**
	 * Muestra el informe del proyecto
	 */
    ...
    public void acercaDe ()
    {
		...
		resultado += " * @author Sebastián Ospino\n";
		resultado += " * @author Ana Sofía Castellanos\n";
		resultado += " * Octubre del 2022\n";
		resultado += " * \n";
     ...
     */
	protected String darDetalleException(Exception e) 
	{
		String resp = "";
	 ...
	 */
	protected String generarMensajeError(Exception e) 
	{
	 ...
	 */
	protected boolean limpiarArchivo(String nombreArchivo) 
	{
		BufferedWriter bw;
		try 
		{
...
//			e.printStackTrace();
	 ...
	 */
	protected void mostrarArchivo (String nombreArchivo)
	{
		try
		{
